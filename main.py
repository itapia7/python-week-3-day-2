...
# The first name of a person "Israel"
# The last name of a person "Tapia"
# The email address of a person "itapia7@gmail.com"
# The percentage of marks obtained by a student 10%
# A variable to store the number of items in a shopping cart number_of_items
...
age_of_jhcp = float(input("what is the age of jhcp?"))
print(age + age_of_jhcp)
